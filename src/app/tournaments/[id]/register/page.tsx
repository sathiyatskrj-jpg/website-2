            ...
            <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
              ...
              <div className="p-4 bg-muted rounded-lg border border-border">
                 ...
                 <div className="space-y-3">
                   <button className="w-full py-3 bg-[#3399cc] text-white font-bold rounded-lg hover:bg-[#2b83b0] transition-colors flex justify-center items-center gap-2 shadow-sm">
                     Pay with Razorpay UI
                   </button>
                   <button className="w-full py-3 bg-[#635BFF] text-white font-bold rounded-lg hover:bg-[#5249ea] transition-colors flex justify-center items-center gap-2 shadow-sm">
                     Pay with Stripe UI
                   </button>
            ...
            <div className="bg-primary text-primary-foreground rounded-xl p-6 shadow-lg shadow-primary/20">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-start">
                  ...
                  <span className="font-semibold text-right max-w-[150px]">3rd A&N State Chess Championship</span>
                </div>
